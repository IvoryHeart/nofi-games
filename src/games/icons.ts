...
export const GAME_ICONS: Record<string, string> = {
  ...
  // Word Ladder: three stacked word tiles with one letter highlighted in each
  'word-ladder': `<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linejoin="round" font-family="sans-serif" font-size="11" font-weight="800"><rect x="10" y="10" width="44" height="14" rx="2"/><rect x="10" y="25" width="44" height="14" rx="2"/><rect x="10" y="40" width="44" height="14" rx="2"/><text x="18" y="20" fill="currentColor" stroke="none">C</text><text x="28" y="20" fill="currentColor" stroke="none">O</text><text x="38" y="20" fill="currentColor" stroke="none" opacity="0.4">L</text><text x="46" y="20" fill="currentColor" stroke="none">D</text><text x="18" y="35" fill="currentColor" stroke="none">C</text><text x="28" y="35" fill="currentColor" stroke="none">O</text><text x="38" y="35" fill="currentColor" stroke="none">R</text><text x="46" y="35" fill="currentColor" stroke="none">D</text><text x="18" y="50" fill="currentColor" stroke="none">C</text><text x="28" y="50" fill="currentColor" stroke="none">A</text><text x="38" y="50" fill="currentColor" stroke="none">R</text><text x="46" y="50" fill="currentColor" stroke="none">D</text></svg>`,
